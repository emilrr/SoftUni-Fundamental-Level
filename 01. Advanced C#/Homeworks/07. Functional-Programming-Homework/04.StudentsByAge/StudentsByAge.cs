...
class StudentsByAge
{
    static void Main()
    {
        var students = new List<Student>
		{
			...
			new Student("Georgi", "Ivanov",20,2,"0897553344","georgi@abv.bg",new List<int> {5, 4, 5, 6},1),
			new Student("Ivan", "Georgiev",22,3,"0888664425","ivanov@@g,ail.com",new List<int> {6, 6, 5, 6},1),
			new Student("Dimitrinka", "Ivanova",22,4,"02-12356","ivanova@gmail.com",new List<int> {5, 5, 5, 5},2),
			new Student("Katya", "Georgieva",25,5,"03022221","jdjdjdj@ght.gh",new List<int> {4, 5, 6, 4},1),
